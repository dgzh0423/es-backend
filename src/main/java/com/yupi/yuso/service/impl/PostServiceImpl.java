...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public List<String> getSearchPrompt(String keyword) {
        ...
        for (Suggest.Suggestion<? extends Suggest.Suggestion.Entry<? extends Suggest.Suggestion.Entry.Option>> value : suggestions) {
            CompletionSuggestion<CompletionSuggestion.Entry<CompletionSuggestion.Entry.Option>> suggestion = (CompletionSuggestion<CompletionSuggestion.Entry<CompletionSuggestion.Entry.Option>>) value;
            ...
            for (CompletionSuggestion.Entry<CompletionSuggestion.Entry<CompletionSuggestion.Entry.Option>> entry : entries) {
                ...
                for (CompletionSuggestion.Entry.Option<CompletionSuggestion.Entry<CompletionSuggestion.Entry.Option>> option : options) {
                    ...
                    SearchHit<CompletionSuggestion.Entry<CompletionSuggestion.Entry.Option>> suggestHits = option.getSearchHit();
                    Object content = suggestHits.getContent();
        ...
        return temps.stream().map(Temp::getText).collect(Collectors.toList());
    }
